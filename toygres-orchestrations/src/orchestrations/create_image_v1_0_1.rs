//! Create Image orchestration v1.0.1
//!
//! Same as v1.0.0 but with custom status reporting for live progress visibility.
...
pub async fn create_image_1_0_1_orchestration(
