/// v1.0.0: Original instance actor — DO NOT MODIFY AFTER DEPLOY
///
/// This is a frozen copy of the original instance_actor_orchestration.
/// It is kept for replay compatibility with orchestrations started on v1.0.0.
...
pub async fn instance_actor_1_0_0_orchestration(
